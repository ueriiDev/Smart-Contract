...
contract TokenTimelock {
	...
	address private immutable _beneficiary5;
	address private immutable _beneficiary6;
	address private immutable _beneficiary7;
    ...
    constructor(
		...
		address beneficiary5_,
		address beneficiary6_,
		address beneficiary7_,
		...
		_beneficiary5 = beneficiary5_;
		_beneficiary6 = beneficiary6_;
		_beneficiary7 = beneficiary7_;
    ...
    function beneficiary4() public view virtual returns (address) {
	    ...
	    function beneficiary5() public view virtual returns (address) {
        return _beneficiary5;
    }
	
	    function beneficiary6() public view virtual returns (address) {
        return _beneficiary6;
    }
	
	    function beneficiary7() public view virtual returns (address) {
        return _beneficiary7;
    }
    ...
    function release() public virtual {
		...
		token().safeTransfer(beneficiary5(), amountsingle);
		token().safeTransfer(beneficiary6(), amountsingle);
		token().safeTransfer(beneficiary7(), amountsingle);
    }
}
